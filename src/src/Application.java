...
public class Application {
    ...
    public static void init() throws IOException {
        ...
        LectureRegistration lectureRegistration8 = new LectureRegistration(8L, "요리조리 자바3", "kwon123", "수요일", 2);
        ...
        student4.setLectureCost(student4.getLectureCost() + 200000L);
        studentRepository.insert(student4);


        Lecture lecture1 = new Lecture("이것이 자바?1", "이것이 자바?", 0, 0, "현우진", "hyeon123");
        lecture1.getLectureRegistrationList().add(lectureRegistration1);
        lecture1.getLectureRegistrationList().add(lectureRegistration7);
        lecture1.getLectureRegistrationIdList().add(1L);
        lecture1.getLectureRegistrationIdList().add(7L);


        lectureRepository.insert(lecture1);
        Lecture lecture2 = new Lecture("저것도 자바?2", "저것이 자바?", 1, 1, "한석원", "han123");
        lecture2.getLectureRegistrationList().add(lectureRegistration3);
        lecture2.getLectureRegistrationList().add(lectureRegistration5);
        lecture2.getLectureRegistrationIdList().add(3L);
        lecture2.getLectureRegistrationIdList().add(5L);


        lectureRepository.insert(lecture2);
        Lecture lecture3 = new Lecture("요리조리 자바3", "요리조리", 2, 2, "현우진", "hyeon123");
        lecture3.getLectureRegistrationList().add(lectureRegistration2);
        lecture3.getLectureRegistrationList().add(lectureRegistration4);
        lecture3.getLectureRegistrationList().add(lectureRegistration6);
        lecture3.getLectureRegistrationList().add(lectureRegistration8);
        lecture3.getLectureRegistrationIdList().add(2L);
        lecture3.getLectureRegistrationIdList().add(4L);
        lecture3.getLectureRegistrationIdList().add(6L);
        lecture3.getLectureRegistrationIdList().add(8L);
